...
export const demoBenchmarks: Benchmark[] = [
  ...
  { id: "b-gsm8k", field_id: "f-math", slug: "gsm8k", name: "GSM8K", description: "Grade-school math word problems.", unit: "%", higher_is_better: true, source_url: "https://paperswithcode.com/sota/arithmetic-reasoning-on-gsm8k" },
  { id: "b-math-comp", field_id: "f-math", slug: "math-comp", name: "MATH", description: "Competition mathematics problems (Hendrycks et al., 2021).", unit: "%", higher_is_better: true, source_url: "https://arxiv.org/abs/2103.03874" },
  { id: "b-aime", field_id: "f-math", slug: "aime-2024", name: "AIME 2024", description: "American Invitational Mathematics Examination (2024).", unit: "%", higher_is_better: true, source_url: "https://openai.com/index/learning-to-reason-with-llms/" },
